...
window.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_modules_language__WEBPACK_IMPORTED_MODULE_4__["default"])("[name='name']");
  Object(_modules_language__WEBPACK_IMPORTED_MODULE_4__["default"])("[name='message']");
...
const forms = () => {
  ...
  form.forEach(a => {
    a.addEventListener("submit", e => {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["postData"])(api, formData).then(() => {
